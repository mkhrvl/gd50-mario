...
gFrames = {
    ...
    -- SPECIFICATION: slice keys from sheet
    ['keys'] = GenerateQuads(gTextures['keys'], 16, 16),
    -- SPECIFICATION: slice locks from sheet
    ['locks'] = GenerateQuads(gTextures['locks'], 16, 16),
    -- SPECIFICATION: slice poles from sheet
    ['poles'] = GenerateQuads(gTextures['poles'], 16, 48),
    -- SPECIFICATION: slice flags from sheet
